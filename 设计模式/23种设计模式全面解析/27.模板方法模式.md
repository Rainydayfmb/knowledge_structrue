...
模板方法模式的结构图如图 1 所示。
![avatar](http://c.biancheng.net/uploads/allimg/181116/3-1Q116095405308.gif)
...
![avator](http://c.biancheng.net/uploads/allimg/181116/3-1Q11609544UV.gif)
程序代码如下： 
```java 
package templateMethod;
...
![avator](http://c.biancheng.net/uploads/allimg/181116/3-1Q116095550123.gif)
程序代码如下： 
```java
package templateMethod;
